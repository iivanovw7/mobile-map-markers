...
/**
 * Processes every variable from `.env` file to create object for webpack.DefinePlugin.
 * @type {{}}
 */
const envParsedKeys = Object.keys(envParsed).reduce((prev, next) => {
...
module.exports = function getWebpackCommonConfig(env) {
    ...
    const plugins = [
        ...
        new webpack.DefinePlugin(envParsedKeys),
    ];
